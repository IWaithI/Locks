package ua.iwaithi.locks.common.util;
...
import ua.iwaithi.locks.mixin.LootPoolAccessor;
import ua.iwaithi.locks.mixin.LootTableAccessor;
...
public final class LocksUtil
{
	...
	public static LootTable lootTableFrom(ResourceLocation loc) throws IOException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException
	{
        Field f;
        try {
            f = ForgeHooks.class.getDeclaredField("lootContext");
        } catch (NoSuchFieldException e) {
            throw new RuntimeException(e);
        }
        f.setAccessible(true);
		ThreadLocal<Deque<?>> tl = (ThreadLocal<Deque<?>>) f.get(null);
